...
// @Router / [get]
func (c *GraphqlService) GetRoot(ctx *gin.Context) {
...
// @Router /albums [get]
func (c *GraphqlService) GetAlbums(ctx *gin.Context) {
...
func (c *GraphqlService) GetAlbumsById(ctx *gin.Context) { // Dynamic through Params
    id := ctx.Param("id")
...
// @Router /hello [post]
func (c *GraphqlService) PostHello(ctx *gin.Context) {
...
// @Router /albums [post]
func (c *GraphqlService) CreateAlbum(ctx *gin.Context) {
