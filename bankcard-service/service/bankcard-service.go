...
// @Router / [get]
func (c *BankcardService) GetRoot(ctx *gin.Context) {
...
// @Router /albums [get]
func (c *BankcardService) GetAlbums(ctx *gin.Context) {
...
func (c *BankcardService) GetAlbumsById(ctx *gin.Context) { // Dynamic through Params
    id := ctx.Param("id")
...
// @Router /hello [post]
func (c *BankcardService) PostHello(ctx *gin.Context) {
...
// @Router /albums [post]
func (c *BankcardService) CreateAlbum(ctx *gin.Context) {
