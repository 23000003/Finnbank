...
// @Router / [get]
func (c *SecurityService) GetRoot(ctx *gin.Context) {
...
// @Router /albums [get]
func (c *SecurityService) GetAlbums(ctx *gin.Context) {
...
func (c *SecurityService) GetAlbumsById(ctx *gin.Context) { // Dynamic through Params
    id := ctx.Param("id")
...
// @Router /hello [post]
func (c *SecurityService) PostHello(ctx *gin.Context) {
...
// @Router /albums [post]
func (c *SecurityService) CreateAlbum(ctx *gin.Context) {
