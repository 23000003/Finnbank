...
// @Router / [get]
func (c *TransactionService) GetRoot(ctx *gin.Context) {
...
// @Router /albums [get]
func (c *TransactionService) GetAlbums(ctx *gin.Context) {
...
func (c *TransactionService) GetAlbumsById(ctx *gin.Context) { // Dynamic through Params
    id := ctx.Param("id")
...
// @Router /hello [post]
func (c *TransactionService) PostHello(ctx *gin.Context) {
...
// @Router /albums [post]
func (c *TransactionService) CreateAlbum(ctx *gin.Context) {
