...
// @Router / [get]
func (c *StatementService) GetRoot(ctx *gin.Context) {
...
// @Router /albums [get]
func (c *StatementService) GetAlbums(ctx *gin.Context) {
...
func (c *StatementService) GetAlbumsById(ctx *gin.Context) { // Dynamic through Params
    id := ctx.Param("id")
...
// @Router /hello [post]
func (c *StatementService) PostHello(ctx *gin.Context) {
...
// @Router /albums [post]
func (c *StatementService) CreateAlbum(ctx *gin.Context) {
