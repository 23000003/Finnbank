...
// @Router / [get]
func (c *GatewayService) GetRoot(ctx *gin.Context) {
...
// @Router /albums [get]
func (c *GatewayService) GetAlbums(ctx *gin.Context) {
...
func (c *GatewayService) GetAlbumsById(ctx *gin.Context) { // Dynamic through Params
    id := ctx.Param("id")
...
// @Router /hello [post]
func (c *GatewayService) PostHello(ctx *gin.Context) {
...
// @Router /albums [post]
func (c *GatewayService) CreateAlbum(ctx *gin.Context) {
