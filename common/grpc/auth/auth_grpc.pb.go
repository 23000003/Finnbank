...
func (c *authServiceClient) SignUpUser(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (UnimplementedAuthServiceServer) SignUpUser(context.Context, *SignUpRequest) (*AuthResponse, error) {
