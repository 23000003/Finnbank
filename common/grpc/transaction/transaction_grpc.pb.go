...
type TransactionServiceClient interface {
	...
	GetTransaction(ctx context.Context, in *TransactionByRefRequest, opts ...grpc.CallOption) (*TransactionDetails, error)
}
...
func (c *transactionServiceClient) GetTransaction(ctx context.Context, in *TransactionByRefRequest, opts ...grpc.CallOption) (*TransactionDetails, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TransactionServiceServer interface {
	...
	GetTransaction(context.Context, *TransactionByRefRequest) (*TransactionDetails, error)
...
func (UnimplementedTransactionServiceServer) GetTransaction(context.Context, *TransactionByRefRequest) (*TransactionDetails, error) {
...
func _TransactionService_GetTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransactionByRefRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).GetTransaction(ctx, req.(*TransactionByRefRequest))
	}
	return interceptor(ctx, in, info, handler)
}
